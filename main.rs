...
impl event::EventHandler for MainState {
    ...
    fn draw(&mut self, ctx: &mut Context) -> GameResult {
        ...
        let racket_rect = graphics::Rect::new(-RACKET_WIDTH_HALF, -RACKET_HIGHT_HALF, RACKET_WIDTH, RACKET_HEIGHT);
...
fn main() -> GameResult {
    let cb = ggez::ContextBuilder::new("Pong", "Name");
